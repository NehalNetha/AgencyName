...
const ExpandableCard: React.FC<ExpandableCardProps> = ({ cards }) => {
  ...
  // Add state for animated particles
  ...
  const handleCardExpand = (index: number) => {
    ...
    // Reset transitioning state after animation completes - faster now
    setTimeout(() => {
                  ...
                  <AnimatePresence>
                    {isExpanded && !isTransitioning && (
                      <motion.div 
                        ...
                        animate={{ opacity: 1 }}
                        exit={{ opacity: 0 }}
                        transition={{ duration: 0.2, delay: 0.1 }} // Faster appearance with less delay
                      >
                        <div className="h-full flex flex-col">
                          <motion.div 
                            ...
                            transition={{ delay: 0.15, type: "spring", stiffness: 400 }} // Faster spring
                          ...
                          <motion.p 
                            ...
                            initial={{ opacity: 0 }}
                            animate={{ opacity: 1 }}
                            transition={{ delay: 0.25 }} // Less delay
                          >
                            {card.description}
                          </motion.p>
                          ...
                          {card.expandedContent && (
                            <motion.div 
                              ...
                              initial={{ opacity: 0 }}
                              animate={{ opacity: 1 }}
                              transition={{ delay: 0.3 }} // Less delay
                            >
                          ...
                          <motion.button
                            ...
                            initial={{ opacity: 0, y: 5 }}
                            animate={{ opacity: 1, y: 0 }}
                            transition={{ delay: 0.35 }} // Less delay
